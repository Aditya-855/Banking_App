...
public class MyJDBC {
    ...
    private static final String DB_PASSWORD="ADITYA@7060";
    ...
    //true - update to database was a success
    //false - update to database was a fail
    ...
    //get all the transactions(used for past transactions)
