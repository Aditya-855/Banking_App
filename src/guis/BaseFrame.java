...
public abstract class BaseFrame extends JFrame {
    ...
    private void initialize(String title){
        ...
        //set layout to null to have absolute layout which allows us to manually specify the size and position of the component
        setLayout(null);
    ...
    //this method will need to be defined by subclass when this class is being inherited from
